 ...
 */
abstract class BaseHash extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    ...
    /**
     * The value for the uri_hash field.
     * @var        string
     */
    protected $uri_hash;
    ...
    /**
     * Initializes internal state of BaseHash object.
     * @see        applyDefaults()
     */
     ...
     * @return Hash The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = HashPeer::ID;
        }
    ...
    /**
     * Set the value of [uri_hash] column.
     *
     * @param string $v new value
     * @return Hash The current object (for fluent API support)
     */
    public function setUriHash($v)
    {
        ...
        if ($this->uri_hash !== $v) {
            $this->uri_hash = $v;
            $this->modifiedColumns[] = HashPeer::URI_HASH;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = HashPeer::CREATED;
            }
    ...
    public function setModified($v)
    {
        ...
        if ($this->modified !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = HashPeer::MODIFIED;
            }
        } // if either are not null
    ...
    public function setIsLocked($v)
    {
        ...
        if ($this->is_locked !== $v) {
            $this->is_locked = $v;
            $this->modifiedColumns[] = HashPeer::IS_LOCKED;
        }
    ...
    public function setGeobinId($v)
    {
        ...
        if ($this->geobin_id !== $v) {
            $this->geobin_id = $v;
            $this->modifiedColumns[] = HashPeer::GEOBIN_ID;
        }
    ...
    public function setExpires($v)
    {
        ...
        if ($this->expires !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = HashPeer::EXPIRES;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->uri_hash = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->created = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->modified = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->is_locked = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
            $this->geobin_id = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->expires = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->resetModified();
            ...
            return $startcol + 7; // 7 = HashPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Hash object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = HashPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                HashPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(HashPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(HashPeer::URI_HASH)) {
            $modifiedColumns[':p' . $index++]  = '`uri_hash`';
        }
        if ($this->isColumnModified(HashPeer::CREATED)) {
            $modifiedColumns[':p' . $index++]  = '`created`';
        }
        if ($this->isColumnModified(HashPeer::MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = '`modified`';
        }
        if ($this->isColumnModified(HashPeer::IS_LOCKED)) {
            $modifiedColumns[':p' . $index++]  = '`is_locked`';
        }
        if ($this->isColumnModified(HashPeer::GEOBIN_ID)) {
            $modifiedColumns[':p' . $index++]  = '`geobin_id`';
        }
        if ($this->isColumnModified(HashPeer::EXPIRES)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`uri_hash`':
                        $stmt->bindValue($identifier, $this->uri_hash, PDO::PARAM_STR);
                        break;
                    case '`created`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = HashPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = HashPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Hash'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Hash'][$this->getPrimaryKey()] = true;
        $keys = HashPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getUriHash(),
            $keys[2] => $this->getCreated(),
            $keys[3] => $this->getModified(),
            $keys[4] => $this->getIsLocked(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setUriHash($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setCreated($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setModified($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setIsLocked($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(HashPeer::ID)) $criteria->add(HashPeer::ID, $this->id);
        if ($this->isColumnModified(HashPeer::URI_HASH)) $criteria->add(HashPeer::URI_HASH, $this->uri_hash);
        if ($this->isColumnModified(HashPeer::CREATED)) $criteria->add(HashPeer::CREATED, $this->created);
        if ($this->isColumnModified(HashPeer::MODIFIED)) $criteria->add(HashPeer::MODIFIED, $this->modified);
        if ($this->isColumnModified(HashPeer::IS_LOCKED)) $criteria->add(HashPeer::IS_LOCKED, $this->is_locked);
        if ($this->isColumnModified(HashPeer::GEOBIN_ID)) $criteria->add(HashPeer::GEOBIN_ID, $this->geobin_id);
        if ($this->isColumnModified(HashPeer::EXPIRES)) $criteria->add(HashPeer::EXPIRES, $this->expires);
    ...
    {
        $criteria = new Criteria(HashPeer::DATABASE_NAME);
        $criteria->add(HashPeer::ID, $this->id);
    ...
    {
        $copyObj->setUriHash($this->getUriHash());
    ...
    {
        return (string) $this->exportTo(HashPeer::DEFAULT_STRING_FORMAT);
    }
