...
abstract class BaseAnnotation extends BaseObject implements Persistent
{
    ...
    /**
     * Initializes internal state of BaseAnnotation object.
     * @see        applyDefaults()
     */
    ...
    public function setPositionId($v)
    {
        ...
        if ($this->position_id !== $v) {
            $this->position_id = $v;
            $this->modifiedColumns[] = AnnotationPeer::POSITION_ID;
        }
    ...
    public function setContent($v)
    {
        ...
        if ($this->content !== $v) {
            $this->content = $v;
            $this->modifiedColumns[] = AnnotationPeer::CONTENT;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AnnotationPeer::CREATED;
            }
    ...
    public function setModified($v)
    {
        ...
        if ($this->modified !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AnnotationPeer::MODIFIED;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->position_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 5; // 5 = AnnotationPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AnnotationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AnnotationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AnnotationPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(AnnotationPeer::POSITION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`position_id`';
        }
        if ($this->isColumnModified(AnnotationPeer::CONTENT)) {
            $modifiedColumns[':p' . $index++]  = '`content`';
        }
        if ($this->isColumnModified(AnnotationPeer::CREATED)) {
            $modifiedColumns[':p' . $index++]  = '`created`';
        }
        if ($this->isColumnModified(AnnotationPeer::MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = '`modified`';
        }

        $sql = sprintf(
            'INSERT INTO `annotation` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`position_id`':
                        $stmt->bindValue($identifier, $this->position_id, PDO::PARAM_STR);
                        break;
                    case '`content`':
    ...
    {
        if (isset($alreadyDumpedObjects['Annotation'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Annotation'][$this->getPrimaryKey()] = true;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setPositionId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AnnotationPeer::POSITION_ID)) $criteria->add(AnnotationPeer::POSITION_ID, $this->position_id);
        if ($this->isColumnModified(AnnotationPeer::CONTENT)) $criteria->add(AnnotationPeer::CONTENT, $this->content);
        if ($this->isColumnModified(AnnotationPeer::CREATED)) $criteria->add(AnnotationPeer::CREATED, $this->created);
        if ($this->isColumnModified(AnnotationPeer::MODIFIED)) $criteria->add(AnnotationPeer::MODIFIED, $this->modified);
     ...
     * @throws PropelException
     */
    public function getPosition(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPosition === null && (($this->position_id !== "" && $this->position_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPosition->addAnnotations($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aPosition instanceof Persistent) {
              $this->aPosition->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(AnnotationPeer::DEFAULT_STRING_FORMAT);
    }
