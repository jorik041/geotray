...
abstract class BaseAnnotationPeer
{
    ...
    const POSITION_ID = 'annotation.position_id';
     ...
     * e.g. AnnotationPeer::$fieldNames[AnnotationPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'PositionId', 'Content', 'Created', 'Modified', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'positionId', 'content', 'created', 'modified', ),
        BasePeer::TYPE_COLNAME => array (AnnotationPeer::ID, AnnotationPeer::POSITION_ID, AnnotationPeer::CONTENT, AnnotationPeer::CREATED, AnnotationPeer::MODIFIED, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'POSITION_ID', 'CONTENT', 'CREATED', 'MODIFIED', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'position_id', 'content', 'created', 'modified', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. AnnotationPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PositionId' => 1, 'Content' => 2, 'Created' => 3, 'Modified' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'positionId' => 1, 'content' => 2, 'created' => 3, 'modified' => 4, ),
        BasePeer::TYPE_COLNAME => array (AnnotationPeer::ID => 0, AnnotationPeer::POSITION_ID => 1, AnnotationPeer::CONTENT => 2, AnnotationPeer::CREATED => 3, AnnotationPeer::MODIFIED => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'POSITION_ID' => 1, 'CONTENT' => 2, 'CREATED' => 3, 'MODIFIED' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'position_id' => 1, 'content' => 2, 'created' => 3, 'modified' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    {
        $toNames = AnnotationPeer::getFieldNames($toType);
        $key = isset(AnnotationPeer::$fieldKeys[$fromType][$name]) ? AnnotationPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(AnnotationPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, AnnotationPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return AnnotationPeer::$fieldNames[$type];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AnnotationPeer::POSITION_ID);
            $criteria->addSelectColumn(AnnotationPeer::CONTENT);
            $criteria->addSelectColumn(AnnotationPeer::CREATED);
            $criteria->addSelectColumn(AnnotationPeer::MODIFIED);
        } else {
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AnnotationPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AnnotationPeer::DATABASE_NAME);
     ...
     *
     * @param      Annotation $obj A Annotation object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            AnnotationPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(AnnotationPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(AnnotationPeer::$instances[$key])) {
                return AnnotationPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (AnnotationPeer::$instances as $instance)
        {
          $instance->clearAllReferences(true);
        }
      }
        AnnotationPeer::$instances = array();
    }
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (Annotation object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = AnnotationPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = AnnotationPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + AnnotationPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = AnnotationPeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doCountJoinPosition(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(AnnotationPeer::POSITION_ID, PositionPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Annotation objects pre-filled with their Position objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinPosition(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        AnnotationPeer::addSelectColumns($criteria);
        $startcol = AnnotationPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = AnnotationPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = AnnotationPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                AnnotationPeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Annotation) to $obj2 (Position)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        AnnotationPeer::addSelectColumns($criteria);
        $startcol2 = AnnotationPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Annotation) to the collection in $obj2 (Position)
                $obj2->addAnnotation($obj1);
    ...
    {
        return Propel::getDatabaseMap(AnnotationPeer::DATABASE_NAME)->getTable(AnnotationPeer::TABLE_NAME);
    }
    ...
    {
        return AnnotationPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a Annotation or Criteria object.
     *
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(AnnotationPeer::ID) && $criteria->keyContainsValue(AnnotationPeer::ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.AnnotationPeer::ID.')');
        }
    ...
    /**
     * Performs an UPDATE on the database, given a Annotation or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(AnnotationPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(AnnotationPeer::ID);
            $value = $criteria->remove(AnnotationPeer::ID);
            if ($value) {
                $selectCriteria->add(AnnotationPeer::ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(AnnotationPeer::TABLE_NAME);
            }
    ...
    /**
     * Deletes all rows from the annotation table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(AnnotationPeer::TABLE_NAME, $con, AnnotationPeer::DATABASE_NAME);
    ...
    /**
     * Performs a DELETE on the database, given a Annotation or Criteria object OR a primary key value.
     *
