...
abstract class BasePositionPeer
{
    ...
    const CREATED = 'position.created';

    /** the column name for the modified field */
    const MODIFIED = 'position.modified';

    /** the column name for the geobin_id field */
    const GEOBIN_ID = 'position.geobin_id';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Lat', 'Lng', 'Created', 'Modified', 'GeobinId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'lat', 'lng', 'created', 'modified', 'geobinId', ),
        BasePeer::TYPE_COLNAME => array (PositionPeer::ID, PositionPeer::LAT, PositionPeer::LNG, PositionPeer::CREATED, PositionPeer::MODIFIED, PositionPeer::GEOBIN_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'LAT', 'LNG', 'CREATED', 'MODIFIED', 'GEOBIN_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'lat', 'lng', 'created', 'modified', 'geobin_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Lat' => 1, 'Lng' => 2, 'Created' => 3, 'Modified' => 4, 'GeobinId' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'lat' => 1, 'lng' => 2, 'created' => 3, 'modified' => 4, 'geobinId' => 5, ),
        BasePeer::TYPE_COLNAME => array (PositionPeer::ID => 0, PositionPeer::LAT => 1, PositionPeer::LNG => 2, PositionPeer::CREATED => 3, PositionPeer::MODIFIED => 4, PositionPeer::GEOBIN_ID => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'LAT' => 1, 'LNG' => 2, 'CREATED' => 3, 'MODIFIED' => 4, 'GEOBIN_ID' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'lat' => 1, 'lng' => 2, 'created' => 3, 'modified' => 4, 'geobin_id' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PositionPeer::LAT);
            $criteria->addSelectColumn(PositionPeer::LNG);
            $criteria->addSelectColumn(PositionPeer::CREATED);
            $criteria->addSelectColumn(PositionPeer::MODIFIED);
            $criteria->addSelectColumn(PositionPeer::GEOBIN_ID);
        } else {
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (PositionPeer::$instances as $instance)
        {
    ...
    public static function doCountJoinGeobin(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(PositionPeer::GEOBIN_ID, GeobinPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Position objects pre-filled with their Geobin objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinGeobin(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Position) to $obj2 (Geobin)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Position) to the collection in $obj2 (Geobin)
                $obj2->addPosition($obj1);
