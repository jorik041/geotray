...
abstract class BaseSettingPeer
{
    ...
    const KEY_NAME = 'setting.key_name';

    /** the column name for the key_value field */
    const KEY_VALUE = 'setting.key_value';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'KeyName', 'KeyValue', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'keyName', 'keyValue', ),
        BasePeer::TYPE_COLNAME => array (SettingPeer::ID, SettingPeer::KEY_NAME, SettingPeer::KEY_VALUE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'KEY_NAME', 'KEY_VALUE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'key_name', 'key_value', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'KeyName' => 1, 'KeyValue' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'keyName' => 1, 'keyValue' => 2, ),
        BasePeer::TYPE_COLNAME => array (SettingPeer::ID => 0, SettingPeer::KEY_NAME => 1, SettingPeer::KEY_VALUE => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'KEY_NAME' => 1, 'KEY_VALUE' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'key_name' => 1, 'key_value' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SettingPeer::KEY_NAME);
            $criteria->addSelectColumn(SettingPeer::KEY_VALUE);
        } else {
