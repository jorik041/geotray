...
abstract class BaseSetting extends BaseObject implements Persistent
{
    ...
    public function setKeyName($v)
    {
        ...
        if ($this->key_name !== $v) {
            $this->key_name = $v;
            $this->modifiedColumns[] = SettingPeer::KEY_NAME;
        }
    ...
    public function setKeyValue($v)
    {
        ...
        if ($this->key_value !== $v) {
            $this->key_value = $v;
            $this->modifiedColumns[] = SettingPeer::KEY_VALUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->key_value = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SettingPeer::KEY_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`key_name`';
        }
        if ($this->isColumnModified(SettingPeer::KEY_VALUE)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setKeyValue($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SettingPeer::KEY_NAME)) $criteria->add(SettingPeer::KEY_NAME, $this->key_name);
        if ($this->isColumnModified(SettingPeer::KEY_VALUE)) $criteria->add(SettingPeer::KEY_VALUE, $this->key_value);
